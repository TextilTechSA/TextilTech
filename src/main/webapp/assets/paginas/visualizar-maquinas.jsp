...
<body class="flex flex-col min-h-screen bg-orchidBlossom font-poppins">
    ...
    <div class="lg:ml-64">
        <main class="pt-20 pb-16">
            <div class="p-4">
                <h1 class="text-3xl font-semibold text-blazeOrange">Visualizar Máquinas</h1>
                <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="mb-4 flex">
                        ...
                        <input type="text" id="searchInput" placeholder="Pesquisar máquinas..."
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Nível de Periculosidade</th>
                                <th scope="col"
                                    class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    Tipo</th>
                            </tr>
                        </thead>
                        <tbody id="machine-list" class="bg-white divide-y divide-gray-200">
                            <!-- Aqui será inserida a lista de máquinas -->
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        // Obter a lista de máquinas do localStorage
        ...
        function displayMachines() {
            ...
            machines.forEach((machine) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${machine.description}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${machine.danger}</td>
        ...
        function searchMachines() {
            ...
            machines.forEach(machine => {
                if (machine.name.toLowerCase().includes(searchTerm)) {
                    const row = document.createElement('tr');
                    row.innerHTML = `
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${machine.name}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">${machine.description}</td>

    ...
    <div class="lg:ml-64">
        <div class="p-4">
            ...
            <div class="mt-6 bg-white p-6 rounded-lg shadow-md">
                <form id="add-machine-form" action="inserir-maquina" onsubmit="showSuccessMessage()">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="time" id="machine-code"  name="horarioInicioOperacao" class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blazeOrange focus:border-blazeOrange sm:text-sm" required>
                    </div>
                    <div class="mb-4">
